            ...
            <RevealOnScroll className="relative z-10">
              ...
              <div className="mt-8 flex items-center gap-4">
                ...
                <p className="text-sm font-medium text-foreground/50">
                  Create an account to access your purchased programs and keep all
            ...
            <RevealOnScroll delayClass="delay-300" className="relative">
              <div className="relative rounded-[2.5rem] border border-white/10 bg-background/60 p-8 shadow-2xl backdrop-blur-xl sm:p-12">
                ...
                <form action={formAction} className="flex flex-col gap-6">
                  {state?.error && (
                    <div className="rounded-lg bg-red-500/10 border border-red-500/20 p-4 text-sm font-semibold text-red-500 text-center">
                      {state.error}
                    </div>
                  )}
                  {/* NAME */}
                  ...
                  {/* PASSWORD */}
                  <div className="flex flex-col gap-2">
                    <label htmlFor="password" className="text-xs font-bold uppercase tracking-[0.1em] text-primary">
                      Password
                    </label>
                    <input
                      id="password"
